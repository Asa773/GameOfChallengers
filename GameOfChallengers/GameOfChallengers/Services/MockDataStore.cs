    ...
    public sealed class MockDataStore : IDataStore
    {
        ...
        public void InitilizeSeedData()
        {
            ...
            var mockItems = new List<Item>
            {
                ...
                new Item { Id = Guid.NewGuid().ToString(), Name = "Gun", Description = "It's a gun", Damage = 5, Value = 5, Range = 5, Attribute = AttributeEnum.Attack, Location = ItemLocationEnum.PrimaryHand, ImageURI="gun.jpg"},
